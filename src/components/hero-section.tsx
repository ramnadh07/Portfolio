...
const HeroSection: React.FC = () => {
  return (
    <AnimatedSection
      id="hero"
      className="min-h-[calc(80vh)] flex flex-col items-center justify-center text-center py-16 md:py-24 lg:py-32 relative overflow-hidden"
    >
      {/* Background Boxes */}
      <div className="absolute inset-0 flex -z-20"> {/* Lower z-index for boxes */}
        ...
        <div className="w-1/6 h-full bg-chart-4/30"></div> {/* Using chart-4 for lavender */}

...
const AboutSection: React.FC = () => {
  return (
    <AnimatedSection id="about" className="scroll-mt-16" delay="delay-100">
      <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 ease-out bg-card border border-border/50 rounded-lg">
        <div className="grid md:grid-cols-3 items-center">
          <div className="md:col-span-1 relative h-64 md:h-full w-full overflow-hidden">
            ...
            />
             <div className="absolute inset-0 bg-gradient-to-t from-card via-transparent to-transparent md:bg-gradient-to-r"></div>
          </div>
          <div className="md:col-span-2 p-6 md:p-10 lg:p-12">
            <CardHeader className="p-0 mb-4">
              <CardTitle className="text-3xl md:text-4xl font-semibold text-primary mb-2">
                About Me
              </CardTitle>
            </CardHeader>
